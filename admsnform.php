...
<html>
    <head>
     ...
     <body style="background-image:url('./images/inbg1.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/ppum.jpg" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <table class="frmtbl">
                ...
                <tr>
                    <td colspan="4"><input type="radio" id="rur" name="rur" value="Rural"><font style="font-family: Verdana;">Rural</font>
                ...
                <tr>
                 ...
                 <tr>
                    <td><font style="font-family: Verdana;">Sr.Secondary</font></td>
                    ...
                    <td><font style="font-family: Verdana;">Aadhar No.</font></td>
               ...
               <tr>
                    ...
                    <td><select id="brnc" name="brnc">
                         ...
                         <option>BACHELORE OF COMPUTER APPLICATION</option>
                         <option>BACHELORE OF BUSINESS MANAGEMENT</option>
                         <option>BACHELORE OF SEICNCE IN INFORMATION TECHNOLOGY</option>
                         </select>
                     </td>
               </tr>
               <tr>
                     ...
                     <td><select id="col" name="col">
                         <option>--------------------Select--------------------</option>
                         <option>AN COLLEGE</option>
                         <option>COLLEGE OF COMMERCE</option>
                         <option>BD COLLEGE</option>
                         <option>JD WOMEN'S COLLEGE</option>
                         </select>
                     </td>
                ...
                <tr>
                 <td><font style="font-family: Verdana;">12th Passing Year</font></td>
                     <td><select id="pcm" name="pcm" required="true">
                         <option>--------------------Select--------------------</option>
                         <option>2022</option>
                         <option>2021</option>
                         <option>2019</option>
