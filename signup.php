...
<html>
    ...
    <body style="background-image:url('./images/bgc4.jpg');">
        ...
        <div id="ddown">
            ...
            <img src="images/sign-up1.jpg" style="height:470px;width:550px;border-top-left-radius:15px;border-bottom-left-radius:15px;" ></img>
            </div>
             <div id="drig">
                 <br>
