...
?>
      <form id="admin" action="admin.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/ppum.jpg" width="100%" style="box-shadow: 0px 5px 5px #999999; "></img>
                  </div>
                 </div>    
             </div>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="./images/PPULOGO-T.gif" width="50%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                  PATLIPUTRA UNIVERSITY, PATNA - 800020, BIHAR</font></center>
                
                <center><font style="font-family:Verdana; font-size:18px;">
                    Phone : 8539856605, Email : ppup@helpeable.com
                    </font></center>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td><font style="font-family: Verdana;"> Parents Mobile No.</font></td>
